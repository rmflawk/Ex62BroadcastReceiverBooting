package com.youngstudio.ex62broadcastreceiverbooting;
...
public class BootingReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        //N(누가)버전 부터는 앱을 설치한 후 적어도 1회 직접 사용자가 런처화면에서 앱아이콘을 클릭하여 실행한 앱만 BOOT_COMPLETE를 받을 수 있음
